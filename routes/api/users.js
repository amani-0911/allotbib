...
// @desc   /api/users/ Reset User Password
...
// @desc    verify email alread register
router.post("/verify",async (req, res, next) => {
  ...
  const resetUrl = `http://localhost:3000/verifyemail/${verifyToken}`;
